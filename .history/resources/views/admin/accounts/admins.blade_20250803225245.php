            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="mobe_tit type2 order4">{{ $account->client->client_type == 'company' ? '병원' : ($account->client->client_type == 'association' ? '협회' : '개인') ?? '-' }}</td>
                        <td class="mobe_tit customer order5">{{ $account->client->name ?? '-' }}</td>
                        <td class="mobe_tit id order6">{{ $account->username ?? 'admin' }}</td>
