...
<div id="mainContent" class="container sub_wrap maintenance_requests_wrap">
	...
	<div class="inner">
		<div class="title"><?=$gName?> <a href="/page_adm/maintenance_requests_write.php" class="btn_write">유지보수 요청하기</a></div>
		...
		<div class="board_list tablet_break chk_board">
			<table>
				...
				<tbody>
					<tr class="hot">
						<td class="chk"><label class="check solo"><input type="checkbox" name="check"><i></i></label></td>
						...
						<td class="tt"><a href="/page_adm/maintenance_requests_view.php">간호간병통합서비스 병동 홈페이지 게시물 수정요청건...</a></td>
					...
					<tr class="hot">
						...
						<td class="tt"><a href="/page_adm/maintenance_requests_view.php">제15회 DAWAS 뉴스레터 발송의 건</a></td>
						<td class="mobe_tit writer">허지선</td>
						<td class="mobe_tit date_recep">2024.07.11</td>
						<td class="mobe_tit date_sched">2024.07.11</td>
						<td class="mobe_tit manager">강심장</td>
					...
					<tr>
						<td class="chk"><label class="check solo"><input type="checkbox" name="check"><i></i></label></td>
						<td class="tac num">13</td>
						<td class="statebox"><span class="state i2">공수확인요청</span></td>
						<td class="mobe_tit customer">강동성심병원...</td>
						<td class="mobe_tit type">오류발생</td>
						<td class="tt"><a href="/page_adm/maintenance_requests_view.php">심초음파학회 오류</a></td>
						<td class="mobe_tit writer">허지선</td>
						<td class="mobe_tit date_recep">2024.07.11</td>
						<td class="mobe_tit date_sched">2024.07.11</td>
						<td class="mobe_tit manager">강심장</td>
					...
					<tr>
						<td class="chk"><label class="check solo"><input type="checkbox" name="check"><i></i></label></td>
						<td class="tac num">12</td>
						<td class="statebox"><span class="state i3">공수확인완료</span></td>
						<td class="mobe_tit customer">강동성심병원...</td>
						<td class="mobe_tit type">SSL(보안인증서)</td>
						<td class="tt"><a href="/page_adm/maintenance_requests_view.php">휴대폰으로 사이트 접속 시 오류 확인 요청 건</a></td>
						<td class="mobe_tit writer">허지선</td>
						<td class="mobe_tit date_recep">2024.07.11</td>
						<td class="mobe_tit date_sched">2024.07.11</td>
						<td class="mobe_tit manager">강심장</td>
					...
					<tr>
						<td class="chk"><label class="check solo"><input type="checkbox" name="check"><i></i></label></td>
						<td class="tac num">11</td>
						<td class="statebox"><span class="state i5">재요청</span></td>
						<td class="mobe_tit customer">강동성심병원...</td>
						<td class="mobe_tit type">콘텐츠 수정</td>
						<td class="tt"><a href="/page_adm/maintenance_requests_view.php">재활용의무이행 실적 변경사항 송부</a></td>
						<td class="mobe_tit writer">허지선</td>
						<td class="mobe_tit date_recep">2024.07.11</td>
						<td class="mobe_tit date_sched">2024.07.11</td>
						<td class="mobe_tit manager">강심장</td>
