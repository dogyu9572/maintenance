					...
					<table>
						...
						<tbody>
							<tr>
								...
								<td class="tt"><a href="{{ route('maintenance.requests.show', 1) }}">간호간병통합서비스 병동 홈페이지 게시물 수정요청건...</a></td>
							...
							<tr>
								...
								<td class="tt"><a href="{{ route('maintenance.requests.show', 2) }}">제15회 DAWAS 뉴스레터 발송의 건</a></td>
							...
							<tr>
								...
								<td class="tt"><a href="{{ route('maintenance.requests.show', 3) }}">심초음파학회 오류</a></td>
								<td class="mobe_tit writer">박은지</td>
								<td class="mobe_tit manager">오유림</td>
								<td class="mobe_tit date_in">2024.07.11</td>
								<td class="mobe_tit date_end"></td>
							...
							<tr>
								...
								<td class="tt"><a href="{{ route('maintenance.requests.show', 4) }}">휴대폰으로 사이트 접속 시 오류 확인 요청 건</a></td>
							...
							<tr>
								...
								<td class="type">콘텐츠 수정</td>
								<td class="tt"><a href="{{ route('maintenance.requests.show', 5) }}">재활용의무이행 실적 변경사항 송부</a></td>
								<td class="mobe_tit writer">김지혜</td>
								<td class="mobe_tit manager">오유림</td>
								<td class="mobe_tit date_in">2024.07.11</td>
								<td class="mobe_tit date_end"></td>
							...
							<tr>
								...
								<td class="type">콘텐츠 수정</td>
								<td class="tt"><a href="{{ route('maintenance.requests.show', 6) }}">자사몰 구매제한 추가 관련</a></td>
								<td class="mobe_tit writer">김지혜</td>
								<td class="mobe_tit manager">오유림</td>
								<td class="mobe_tit date_in">2024.07.11</td>
							...
							<tr>
								...
								<td class="state_box"><span class="state i4">진행중</span></td>
								<td class="type">콘텐츠 수정</td>
								<td class="tt"><a href="{{ route('maintenance.requests.show', 7) }}">관리자 페이지 기능 문의</a></td>
								<td class="mobe_tit writer">김지혜</td>
								<td class="mobe_tit manager">오유림</td>
								<td class="mobe_tit date_in">2024.07.11</td>
								<td class="mobe_tit date_end">2024.07.11</td>
							...
							<tr>
								...
								<td class="state_box"><span class="state i6">작업완료</span></td>
								<td class="type">콘텐츠 수정</td>
								<td class="tt"><a href="{{ route('maintenance.requests.show', 8) }}">틴매일경제 홈페이지 수정사항 요청의 건</a></td>
								<td class="mobe_tit writer">김지혜</td>
								<td class="mobe_tit manager">오유림</td>
								<td class="mobe_tit date_in">2024.07.11</td>
								<td class="mobe_tit date_end">2024.07.11</td>
							...
							<tr>
								...
								<td class="state_box"><span class="state i6">작업완료</span></td>
								<td class="type">콘텐츠 수정</td>
								<td class="tt"><a href="{{ route('maintenance.requests.show', 9) }}">자사몰 구매제한 추가 관련</a></td>
							...
							<tr>
								...
								<td class="state_box"><span class="state i6">작업완료</span></td>
								<td class="type">콘텐츠 수정</td>
								<td class="tt"><a href="{{ route('maintenance.requests.show', 10) }}">제15회 DAWAS 뉴스레터 발송의 건</a></td>
								<td class="mobe_tit writer">서은정</td>
								<td class="mobe_tit manager">오유림</td>
								<td class="mobe_tit date_in">2024.07.11</td>
								<td class="mobe_tit date_end">2024.07.11</td>
